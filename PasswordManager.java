...
class SplashScreen {
    ...
    public void createGUI(){
        ...
        frame.getContentPane().setBackground(new Color(0x670000)); // to set the background color of the frame
    ...
    public void addProgressBar(){
        ...
        progressBar.setForeground(new Color(0xE59A38));
...
class PasswordManager implements ActionListener {
    ...
    public void GUIButtonsSetting(JButton btn){
        btn.setBackground(new Color(0x560495));
